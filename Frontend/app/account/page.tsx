...
export default function AccountPage() {
  ...
  const [phoneInput, setPhoneInput] = useState(typeof window !== 'undefined' ? localStorage.getItem('phone') || '' : '');
  ...
  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('AccountPage: save clicked', { nameInput, emailInput, phoneInput });
